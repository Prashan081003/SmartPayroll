        ...
        <div class="form-row">
            <div class="form-group">
                <?= $this->Form->control('department', [
                    ...
                    'class' => !empty($employee->errors('department')) ? 'error-field' : ''
                ]) ?>
                <?php if (!empty($employee->errors('department'))): ?>
                    <div class="error-message"><?= implode(', ', $employee->errors('department')) ?></div>
                <?php endif; ?>
            </div>
